...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = 'Vielen Dank. Deine Nachricht wurde gesendet.';
	$response_error = 'Fehler. Bitte versuch es erneut.';
